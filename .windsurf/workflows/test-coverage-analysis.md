...
## Step 2: If information is correct, check for unit test coverage by running `npm test -- --coverage --verbose` and summarize the coverage result into a table and output that to the user. If the information has changed, inform the user and list out the most updated information.

## Step 3: Use the unit test coverage information, pick one file that has the lowest test coverage rate and analyze what functions or parts of the code are not covered yet.

## Step 4: E2E Test Coverage Check
...
## Step 5: Summarize your findings and output the summary along with a few recommendations
